...
const Profile = (props) => {
  ...
  useEffect(() => {
    fetch(
      "https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyBs6tNL-lygc73SI0m7rbUpcSBMWLNlaao",
      {
        method: "POST",
        body: JSON.stringify({
          idToken: idToken,
  ...
  const updateHandler = (event) => {
    ...
    let errorMessage;
    fetch(
      "https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyBs6tNL-lygc73SI0m7rbUpcSBMWLNlaao",
      {
        method: "POST",
