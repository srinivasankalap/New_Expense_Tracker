...
const Authentication = (props) => {
  ...
  const submitHandler = (event) => {
    ...
    if (isLogin) {
      url =
      'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBs6tNL-lygc73SI0m7rbUpcSBMWLNlaao';
    }
    if (!isLogin && enterdPassword === enterdConfirmPassword) {
      url =
      'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBs6tNL-lygc73SI0m7rbUpcSBMWLNlaao';
    }
